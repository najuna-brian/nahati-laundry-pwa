      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">
            {isLogin ? 'Welcome Back' : 'Join Nahati Laundry'}
          </h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 transition duration-200 mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          {!isLogin && (
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                We'll use this number to send you order updates on WhatsApp
              </p>
            </div>
          )}
